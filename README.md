...
5. Crypto Currency Analysis : (File Name : Crypto.ipynb) Data analysis, visualization and model testing and selection is done for Crypto Currencies using pandas, numpy, matplotlib, seaborn and Scikit-learn.   
